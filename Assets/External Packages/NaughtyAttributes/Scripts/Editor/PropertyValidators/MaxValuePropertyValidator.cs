        ...
        public override void ValidateProperty(SerializedProperty property)
        {
            ...
            else if (property.propertyType == SerializedPropertyType.Vector2)
            {
                property.vector2Value = Vector2.Min(
                    property.vector2Value, new Vector2(maxValueAttribute.MaxValue, maxValueAttribute.MaxValue)
                );
            }
            ...
            else if (property.propertyType == SerializedPropertyType.Vector4)
            {
                property.vector4Value = Vector4.Min(
                    ...
                    new Vector4(
                        maxValueAttribute.MaxValue, maxValueAttribute.MaxValue, maxValueAttribute.MaxValue,
            ...
            else if (property.propertyType == SerializedPropertyType.Vector3Int)
            {
                property.vector3IntValue = Vector3Int.Min(
                    ...
                    new Vector3Int(
                        (int) maxValueAttribute.MaxValue, (int) maxValueAttribute.MaxValue,
