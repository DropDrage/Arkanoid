        ...
        public override void ValidateProperty(SerializedProperty property)
        {
            ...
            else if (property.propertyType == SerializedPropertyType.Vector2)
            {
                property.vector2Value = Vector2.Max(
                    property.vector2Value, new Vector2(minValueAttribute.MinValue, minValueAttribute.MinValue)
                );
            }
            ...
            else if (property.propertyType == SerializedPropertyType.Vector4)
            {
                property.vector4Value = Vector4.Max(
                    ...
                    new Vector4(
                        minValueAttribute.MinValue, minValueAttribute.MinValue, minValueAttribute.MinValue,
            ...
            else if (property.propertyType == SerializedPropertyType.Vector3Int)
            {
                property.vector3IntValue = Vector3Int.Max(
                    ...
                    new Vector3Int(
                        (int) minValueAttribute.MinValue, (int) minValueAttribute.MinValue,
