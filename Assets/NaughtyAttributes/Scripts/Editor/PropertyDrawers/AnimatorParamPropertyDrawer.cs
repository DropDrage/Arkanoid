    ...
    public class AnimatorParamPropertyDrawer : PropertyDrawerBase
    {
        ...
        protected override void OnGUI_Internal(Rect rect, SerializedProperty property, GUIContent label)
        {
            ...
            AnimatorController animatorController = GetAnimatorController(
                property, animatorParamAttribute.AnimatorName
            );
            if (animatorController == null)
            {
                DrawDefaultPropertyAndHelpBox(
                    rect, property, InvalidAnimatorControllerWarningMessage, MessageType.Warning
                );
                return;
            }
            ...
            switch (property.propertyType)
            {
                ...
                default:
                    DrawDefaultPropertyAndHelpBox(
                        rect, property, string.Format(InvalidTypeWarningMessage, property.name), MessageType.Warning
                    );
                    break;
            }
        ...
        private static AnimatorController GetAnimatorController(SerializedProperty property, string animatorName)
        {
            ...
            FieldInfo animatorFieldInfo = ReflectionUtility.GetField(targetTypes, animatorName);
            ...
            PropertyInfo animatorPropertyInfo = ReflectionUtility.GetProperty(targetTypes, animatorName);
            ...
            MethodInfo animatorGetterMethodInfo = ReflectionUtility.GetMethod(targetTypes, animatorName);
